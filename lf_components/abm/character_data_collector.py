...
class ABMCharacterDataCollector(Component):
    ...
    def collect_character_data(
        ...
        book_id: str,
        output_directory: str = "data/characters"
    ) -> Data:
        ...
        self.status = f"Collected data for {stats['characters_found']} characters, {stats['dialogue_count']} dialogue utterances"
    ...
    def _has_character_mention(self, text: str) -> bool:
        ...
        character_indicators = [
            "quinn", "he", "she", "his", "her", "him", "they", "their",
            "boy", "girl", "man", "woman", "student", "character"
        ]
